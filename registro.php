...
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    if(isset($_POST['registrar'])) {
      ...
      $comprobarusuario = mysql_num_rows(mysqli_query($connect,"SELECT usuario FROM usuarios WHERE usuario = '$usuario'"));

      $comprobaremail = mysql_num_rows(mysqli_query($connect,"SELECT email FROM usuarios WHERE email = '$email'"));
